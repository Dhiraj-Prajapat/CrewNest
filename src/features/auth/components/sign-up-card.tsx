...
//       )}
//       <CardContent className="space-y-2">
//         <form onSubmit={onPasswordSignUp} className="space-y-4 signup-form">
//           <div className="space-y-2">
//             <Label htmlFor="name">Name</Label>
//             <Input
//               disabled={pending}
...
export function SignUpCard({ setState }: SignUpCardProps) {
  ...
  const onPasswordSignUp = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!passwordRegex.test(password)) {
      setErrors((prev) => ({
        ...prev,
        password:
          "Password must include uppercase, lowercase, number, special character, and no weak words.",
      }));
      return;
    }
  ...
  return (
    <Card className="w-full max-w-md mx-auto px-6 bg-primary-l text-white">
      <CardHeader>
        <h2 className="text-2xl font-bold text-center">Sign Up to Continue</h2>
      </CardHeader>
      ...
      <CardContent className="space-y-2">
        <form onSubmit={onPasswordSignUp} className="space-y-4 signup-form">
          <div className="space-y-2">
            <Label htmlFor="name">Name</Label>
            <Input
              className="bg-[#f2f0eb] text-gray-900"
              disabled={pending}
              id="name"
              placeholder="Enter your name"
              value={name}
        ...
        <div className="flex flex-col space-y-2">
          <Button
            ...
            variant="outline"
            size="lg"
            className="w-full relative text-gray-900"
          >
            <FaGoogle />
            Continue with Google
          </Button>
